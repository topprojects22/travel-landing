            ...
            <div className={'container mx-auto px-4 sm:px-6 lg:px-8'}>
                <div className={'flex flex-col lg:flex-row items-center gap-12'}>
                    ...
                    >
                        <motion.div
                            className={
                                'inline-block px-4 py-1 bg-teal-100 rounded-full text-teal-800 text-sm font-medium mb-6'
                            }
                            initial={{ opacity: 0, y: -20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        <div className={'flex flex-col sm:flex-row gap-4 justify-center lg:justify-start'}>
                            ...
                            <Button
                                ...
                                variant={'outline'}
                                className={
                                    'text-lg border-gray-300 text-gray-700 hover:border-teal-600 hover:text-teal-600 group'
                                }
                                onClick={() => setShowVideo(true)}
                            >
                                <Play
                                    className={'mr-2 h-5 w-5 fill-current group-hover:scale-110 transition-transform'}
                                />
                                {t('watchDemo')}
                            </Button>
                        </div>
                        ...
                        <div className={'relative'}>
                            ...
                            >
                                <div className={'flex items-center gap-3 mb-2'}>
                                    <div
                                        className={
                                            'w-10 h-10 bg-teal-100 rounded-full flex items-center justify-center'
                                        }
                                    >
            ...
            {showVideo && (
                ...
                >
                    ...
                    >
                        <button
                            className={
                                'absolute top-4 right-4 text-gray-500 bg-white/90 rounded-full p-2 hover:bg-gray-100 transition-colors z-10'
                            }
                            onClick={() => setShowVideo(false)}
                        >
                            ✕
